...
if ($isBannerVideo): ?>
          <video src="<?= $bannerMedia ?>" class="banner-image" style="object-fit: cover; width: 100%; height: 100%;" autoplay loop muted playsinline></video>
<?php else: ?>
            ...
            <div class="post-card" style="margin-bottom: 20px">
              ...
              <div class="post-content">
                <div class="post-video-container" style="height: 100%">
                  <?php if ($is_video): ?>
                  <video src="<?= $media ?>" style="scale: 1.2;" class="post-video" autoplay loop muted playsinline webkit-playsinline="true" x-webkit-airplay="allow" preload="auto"></video>
                  <?php else: ?>
              ...
              <div class="media-item" onclick="abrirModal('mensal', _P.mensal.nome, _P.mensal.preco, _P.mensal.bonus); return false;" style="cursor: pointer;">
                ...
                ?>
                  <div class="mini-carousel">
                    ...
                    ?>
                      <?php if ($is_video): ?>
                        <video src="<?= $cMedia ?>" class="mini-carousel-item <?= $idx === 0 ? 'active' : '' ?>" style="filter: blur(<?= $blurLevel ?>px); transform: scale(1.3);" autoplay loop muted playsinline></video>
                      <?php else: ?>
                ...
                ?>
                  <?php if ($is_video): ?>
                    <video src="<?= $media ?>" style="width: 100%; height: 100%; object-fit: cover; filter: blur(<?= $blurLevel ?>px); transform: scale(1.3);" autoplay loop muted playsinline></video>
                  <?php else: ?>
      ...
      <div class="unlock-modal-container">
        ...
        <div class="unlock-media-container">
          <div class="mini-carousel" style="width: 100%; height: 100%;">
            ...
            ?>
              <?php if ($is_video): ?>
                <video src="<?= $pMedia ?>" class="mini-carousel-item <?= $idx === 0 ? 'active' : '' ?>" style="filter: blur(8px); transform: scale(1.3); width: 100%; height: 100%; object-fit: cover;" autoplay loop muted playsinline></video>
              <?php else: ?>
